...
class GPT(nn.Module):
    ...
    def configure_optimizers(self, train_config, model: Optional[torch.nn.Module] = None, multiple_optim_groups: bool = True):
        ...
        For pytorch native fully sharded data parallel (fsdp), the optimizer has to take the sharded model's parameters
        and can only have a single optimizer group.
        """
